<script lang="ts">
	...
	import { LibraryBig, LogOut, MoonIcon, SunIcon } from 'lucide-svelte';
	...
	<div class="flex items-center justify-between p-2">
		...
		{#if data.user}
			<div class="flex items-center gap-2">
				...
				<!-- Weirdness with items-center and the separator component (known issue) -->
				<div class="self-stretch">
					<Separator orientation="vertical" />
				</div>
				<Button variant="ghost" href="/logout" size="icon">
					<LogOut color="red" />
				</Button>
			</div>
		{/if}
